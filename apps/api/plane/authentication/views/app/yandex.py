...
class YandexOauthInitiateEndpoint(View):
    def get(self, request):
        ...
        try:
            ...
            provider = YandexOAuthProvider(request=request, state=state)
...
class YandexCallbackEndpoint(View):
    def get(self, request):
        ...
        if not code:
            ...
            return HttpResponseRedirect(url)
        try:
            provider = YandexOAuthProvider(request=request, code=code, callback=post_user_auth_workflow)
